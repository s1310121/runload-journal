...
import { applyA9ConditionOverlay, A9_APP_OVERLAY_VERSION, A9_APP_AUTHORITY_VERSION } from "./a9V19Historical/a9AppConditionOverlay.js";

export const REGIONAL_V1_MODEL_VERSION = "runload-regional-model-fcr-v1.9-app-v1.0";
export const REGIONAL_V1_ENGINE_BUILD = "runload-prototype-integration-v1.1-a6-candidate-trace1";
export const REGIONAL_V1_OUTPUT_SEMANTIC_VERSION = "runload-regional-output-semantics-fcr-v1.9-app-v1.0";
...
export function createRegionalV1ResultRecord({ record, feedback = {}, sessionSequence = 1 }) {
  ...
  const a9Overlay = applyA9ConditionOverlay(calculation.value, record);
