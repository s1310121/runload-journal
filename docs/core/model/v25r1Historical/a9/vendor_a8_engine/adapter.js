...
import { hasTreadmillOutdoorSurfaceMixFromComponents } from "../../../modelConstants.js";
...
export function adaptPrototypeRecord(uiInput, context={}) {
  try {
    ...
    if (hasTreadmillOutdoorSurfaceMixFromComponents(surface.components)) return failure("TREADMILL_OUTDOOR_MIX_FORBIDDEN","surface.treadmill_outdoor_mix_forbidden","course.surfaceSelections",{});
