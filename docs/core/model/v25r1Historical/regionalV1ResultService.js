...
export const REGIONAL_V1_MODEL_VERSION = "runload-regional-model-fcr-v2.5r1";
export const REGIONAL_V1_ENGINE_BUILD = "runload-prototype-integration-v1.1-a6-candidate-trace1";
export const REGIONAL_V1_OUTPUT_SEMANTIC_VERSION = "runload-regional-output-semantics-fcr-v2.5r1";
export const A7_SEMANTIC_DECOMPOSITION_VERSION = "runload-v2.5r1-canonical-condition-semantics-1.0";
