...
export const A9_V25R1_CADENCE_VERSION = "RunLoad-V2.6C1-cadence-personal-reference-v1.0";
...
function priorEligible(record,currentSpeed,tolerance,currentId){
  return record?.id !== currentId
    ...
    && regionalModelSnapshotForRecord(record).snapshotId === REGIONAL_MODEL_SNAPSHOT_IDS.v26c1
...
export function deriveV25R1PersonalHabitualCadence({currentRecord={}, priorRecords=[]}={}){
  ...
  const currentFamily=regionalModelSnapshotForRecord(currentRecord).snapshotId===REGIONAL_MODEL_SNAPSHOT_IDS.v26c1;
