...
export function renderSubjectiveInputScreen({ context }) {
  ...
  return `<section class="screen screen--subjective-input">
    ...
    <div class="safety-notice subjective-boundary-notice"><strong>本人の身体記録と数値結果は分けて保存します。</strong><p>身体図から選ぶ部位と程度は、本人が感じた内容の記録です。12部位の比較値とは別に保存・表示し、比較値の数値補正や診断・走行可否の判定には使いません。</p></div>
