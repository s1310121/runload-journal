...
function renderReusableProfile(profile = {}, settings = {}) {
  ...
  return `<section class="form-section" aria-labelledby="settings-profile-title">
    ...
    <div class="source-boundary settings-boundary"><p><strong>数値結果には使いません。</strong> 部位ごとの負荷傾向指数、走行全体の比較用推定値、傷害や安全の判断へ、身長・体重・年齢帯・性別・経験・目的によって数値を変えません。</p><p>すべて任意で、空欄のまま利用できます。</p></div>
    ...
    <details class="settings-advanced"><summary><span><strong>身体に関する任意情報</strong><small>必要な場合だけ入力します。数値結果は変わりません。</small></span></summary><div class="settings-advanced__body">
      <div class="field-grid field-grid--two">
        <label class="field"><span>身長（cm・任意）</span><input name="profileHeightCm" type="number" inputmode="decimal" min="100" max="230" step="0.1" value="${escapeHtml(profile.heightCm ?? "")}"><small>記録の文脈として保存するだけで、部位ごとの負荷傾向指数や走行全体の比較用推定値へ掛けません。</small></label>
